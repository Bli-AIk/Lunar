...
public enum KeyCode
{
    ...
    /// <summary>
    ///     <para>
    ///         Maps to right Windows key or right Command key if physical keys are enabled in Input Manager settings,
    ///         otherwise maps to right Command key only.
    ///     </para>
    /// </summary>
    ...
    /// <summary>
    ///     <para>
    ///         Maps to left Windows key or left Command key if physical keys are enabled in Input Manager settings,
    ///         otherwise maps to left Command key only.
    ///     </para>
    /// </summary>
